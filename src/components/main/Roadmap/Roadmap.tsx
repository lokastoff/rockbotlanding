...
export const Roadmap:React.FC = () => {
    return(
        <section className="roadmap py-[120px] w-full ">
            <motion.div className="contentConataner px-[60px] w-full max-w-[1280px] m-auto" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{once:true}} transition={{duration:0.7, delay:0.4}}>
